...
class JEC_Medium {
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script('bootstrap-js', 'https://stackpath.bootstrapcdn.com/bootstrap/5.1.3/js/bootstrap.bundle.min.js', [], '5.1.3', true);
    ...
    public function medium_feed_shortcode($atts) {
        ...
        ob_start();
        ?>
        <div class="medium-feed container">
            <div class="row">
                <?php foreach ($posts as $post): ?>
                    <div class="medium-post col-md-4">
                        <div class="card mb-4">
                            <div class="card-img-top-wrapper" style="height: 200px; overflow: hidden;">
                                <img src="<?php echo esc_url($post['image']); ?>" class="card-img-top" alt="<?php echo esc_attr($post['title']); ?>" style="height: 100%; width: auto; object-fit: cover;">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title"><a href="<?php echo esc_url($post['link']); ?>"><?php echo esc_html($post['title']); ?></a></h5>
