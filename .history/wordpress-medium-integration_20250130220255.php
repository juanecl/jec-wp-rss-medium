                ...
                <?php foreach ($posts as $index => $post): ?>
                    ...
                    <?php endif; ?>
                                <div class=" d-flex align-items-stretch">
                                    <div class="col-12 col-md-4 col-xs-12 col-sm-12 card mb-4 bg-secondary-muted text-white" style="border: 3px solid var(--bs-secondary);box-shadow: 5px 5px 0 rgba(0,0,0,0.3);">
                    ...
                    <?php if ($index % 3 == 2 || $index == count($posts) - 1): ?>
                            </div>
                        </div>
                    <?php endif; ?>
                <?php endforeach; ?>
