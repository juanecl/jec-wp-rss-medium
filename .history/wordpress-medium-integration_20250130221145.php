        ...
        <div id="mediumCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <?php foreach ($posts as $index => $post): ?>
                    <div class="carousel-item <?php echo $index <= 3 ? 'active' : ''; ?>">
                        <div class="col-12 col-md-4 card mb-4 bg-secondary-muted text-white" style="border: 3px solid var(--bs-secondary);box-shadow: 5px 5px 0 rgba(0,0,0,0.3);">
